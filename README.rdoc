...
=== Use with a Mongo ORM

If you're not using ActiveRecord then you'll need to manually include the module in any class you wish to use the fires method.

    class User
      include TimelineFu::Fires
